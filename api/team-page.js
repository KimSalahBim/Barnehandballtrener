...
var EX_MAP = {
    ...
    tag:{n:'Lenkesisten',c:'sjef_over_ballen'},
    warm_ball:{n:'Ball-oppvarming',c:'sjef_over_ballen'},
    rondo_easy:{n:'Ballbesittelse i ring',c:'spille_med_og_mot'},
    driving:{n:'Dribling og retningsforandring',c:'sjef_over_ballen'},
    pass_pair:{n:'Kast to og to',c:'sjef_over_ballen'},
    pass_move:{n:'Pasning og løp',c:'sjef_over_ballen'},
    turn:{n:'Finter og avløp',c:'spille_med_og_mot'},
    receive_turn:{n:'Mottak og viderespill',c:'sjef_over_ballen'},
    shot:{n:'Kast på mål',c:'scoringstrening'},
    shot_race:{n:'Skuddkonkurranse',c:'scoringstrening'},
    '1v1':{n:'1 mot 1',c:'spille_med_og_mot'},
    '2v1':{n:'2 mot 1',c:'spille_med_og_mot'},
    '3v2':{n:'3 mot 2',c:'spille_med_og_mot'},
    ssg:{n:'4-er håndball',c:'smalagsspill'},
    possession:{n:'10-trekkslek',c:'smalagsspill'},
    game_activity:{n:'Fri spillaktivitet',c:'smalagsspill'},
    keeper:{n:'Keepertrening',c:'sjef_over_ballen'},
    ball_tag:{n:'Ballsisten (fri)',c:'sjef_over_ballen'},
    defend_press:{n:'Forsvarstrening',c:'spille_med_og_mot'},
    ssg_theme:{n:'Kamp med tema',c:'smalagsspill'},
    transition:{n:'Overgang forsvar-angrep',c:'smalagsspill'},
    wall_pass:{n:'Veggspill og avløp',c:'spille_med_og_mot'},
    finish_assist:{n:'Kast etter kombinasjon',c:'scoringstrening'},
    keeper_play:{n:'Keeper i spill',c:'sjef_over_ballen'},
    relay_ball:{n:'Dribling- og kastestafett',c:'sjef_over_ballen'},

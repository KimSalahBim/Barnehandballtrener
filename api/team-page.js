...
var EX_MAP = {
    ...
    kjeglelek:{n:'Kjeglelek',c:'sjef_over_ballen'},
    stussball:{n:'Stussball',c:'sjef_over_ballen'},
    mattespill:{n:'Mattespill',c:'sjef_over_ballen'},
    forflytning:{n:'Forflytning',c:'spille_med_og_mot'},
    snapp:{n:'Snapp',c:'spille_med_og_mot'},
    blokk:{n:'Blokk',c:'spille_med_og_mot'},
    takle:{n:'Takle',c:'spille_med_og_mot'},
    krysning:{n:'Krysningsspill',c:'spille_med_og_mot'},
    padrag:{n:'Pådrag og viderespill',c:'spille_med_og_mot'},
    ssg_2v2_sektor:{n:'2 mot 2 i sektorer',c:'smalagsspill'},
    ssg_3v2_linje:{n:'3 mot 2 med linje',c:'smalagsspill'},
    step_shot:{n:'Stegskudd',c:'scoringstrening'},
    wing_shot:{n:'Kantskudd',c:'scoringstrening'},
    line_shot:{n:'Linjeskudd',c:'scoringstrening'},
    islandsk_kontra:{n:'Islandsk kontra',c:'scoringstrening'},
    bolgen:{n:'Bølgen',c:'scoringstrening'},
    korridor:{n:'Korridorspill',c:'smalagsspill'},
    finte_kjegle:{n:'Finte mot kjegle',c:'sjef_over_ballen'},
    finte_forsvarer:{n:'Finte mot forsvarer',c:'spille_med_og_mot'},
    avlop:{n:'Avløp: kom deg fri',c:'spille_med_og_mot'},
};
